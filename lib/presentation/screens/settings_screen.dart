              ...
              children: <Widget>[
                ...
                _Section(
                  ...
                  children: <Widget>[
                    ...
                    SwitchListTile(
                      key: const Key('show-viewer-comment-count-switch'),
                      title: const Text('リスナー数・コメント数'),
                      contentPadding: EdgeInsets.zero,
                      value: settings.showViewerCommentCount,
                      onChanged: settings.statisticsEnabled
                          ? (bool value) {
                              _saveNextSettings(settings.copyWith(
                                  showViewerCommentCount: value));
                            }
                          : null,
                    ),
                    SwitchListTile(
                      key: const Key('show-active-user-count-switch'),
