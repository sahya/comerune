package app.spectacles_software.comerune.speech.infrastructure.plugin
...
import app.spectacles_software.comerune.speech.domain.controller.SpeechController
import app.spectacles_software.comerune.speech.domain.controller.SpeechControllerImpl
...
import app.spectacles_software.comerune.speech.domain.model.ReplaceRule
...
import app.spectacles_software.comerune.speech.domain.model.SynthesisMode
import app.spectacles_software.comerune.speech.domain.model.VoicevoxModelManifest
import app.spectacles_software.comerune.speech.domain.normalizer.DefaultCommentNormalizer
import app.spectacles_software.comerune.speech.domain.normalizer.InMemoryDuplicateDetector
...
import app.spectacles_software.comerune.speech.domain.settings.InMemorySettingsRepository
import app.spectacles_software.comerune.speech.infrastructure.engine.VoicevoxEngineImpl
import app.spectacles_software.comerune.speech.infrastructure.event.FlutterSpeechEventEmitter
import app.spectacles_software.comerune.speech.infrastructure.player.AndroidTtsSpeaker
import app.spectacles_software.comerune.speech.infrastructure.player.SwitchableWavPlayer
import app.spectacles_software.comerune.speech.infrastructure.repository.VoicevoxModelRepositoryImpl
...
class CommentSpeechPlugin :
    ...
    companion object {
        ...
        const val METHOD_CHANNEL = "app.spectacles_software.comerune.speech/methods"
        const val EVENT_CHANNEL = "app.spectacles_software.comerune.speech/events"
    }
