  ...
  group('SettingsScreen app update tile', () {
    ...
    testWidgets('manual check reports up to date', (WidgetTester tester) async {
      await tester.pumpWidget(
        _buildScreen(
          newStore(),
          versionUpdateChecker: _checkerReturning(<String, Object?>{
            'latest': '1.2.0',
            'minSupported': '1.0.0',
          }),
...
VersionUpdateChecker _checkerReturning(Map<String, Object?> body) {
  ...
  return VersionUpdateChecker(
    repository: AppVersionRepository(
      endpoint: 'https://updates.invalid/api/app-version',
      httpClient: mock,
    ),
