  ...
  group('FavoriteUserListScreen', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final AppSettings initial = AppSettings.defaults.addFavoriteUserId(
          '12345',
        );
    ...
    testWidgets('displays userId only when resolveUserName returns null', (
      ...
      await tester.pumpWidget(
        _buildScreen(store, resolveUserName: (String userId) => null),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('delete confirmation dialog shows nickname when available', (
      ...
      expect(find.text('お気に入り太郎 (12345) を削除しますか？'), findsOneWidget);
    });
  });
}
